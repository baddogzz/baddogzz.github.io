...
不过实操的过程中我们会发现，第三方的玩家会经常 **抖动** 或者 **滑步**，即便我们提高同步频率到每帧同步，也无法完全避免这种情况，这是为什么呢？
...
事实上，如果我们在持续移动，这里无需做特别的处理，因为第三方客户端一致保持的是正在追赶正确位置的状态。

这里的误差不会累积，因为我们会根据追赶距离按照一定的策略调整移动速度。
